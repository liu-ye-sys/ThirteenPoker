...
def main():
    ...
    pygame.display.set_caption('福建十三水')
    screen.fill((255, 255, 255))
    clock = pygame.time.Clock()
    # 加载背景
    background = pygame.image.load('res/background.jpg.png')
    background_rank = pygame.image.load('res/rank.png.png')
    background_history = pygame.image.load('res/history.png.png')
    ...
    for suite in suites:
        for face in faces:
          key = suite + face
          res = 'res/cards/' + faces[face] + '_' + suites[suite] + '.png.png'
          img = pygame.image.load(res).convert()
          card_dirt[key] = img
    
    # 按钮
    button_login = Button('res/buttons/login.png.png', 433, 420)
    button_register = Button('res/buttons/register.png.png', 228, 420)
    button_back = Button('res/buttons/back.png.png', 433, 420)
    button_back_2 = Button('res/buttons/back.png.png', 0, 0)
    button_open = Button('res/buttons/open.png', 300, 300)
    button_history_detail = Button('res/buttons/history_detail.png.png', 680, 78)
    button_history = Button('res/buttons/history.png.png', 680, 39)
    button_rank = Button('res/buttons/rank.png.png', 680, 0)
    button_login.draw(screen)
    button_register.draw(screen)
    button_b1 = Button('res/buttons/b.png.png', 210, 462)
    button_n1 = Button('res/buttons/n.png.png', 520, 462)
    button_b2 = Button('res/buttons/b.png.png', 196, 508)
    button_n2 = Button('res/buttons/n.png.png', 516, 508)
